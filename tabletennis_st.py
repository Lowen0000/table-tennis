...
# --- 1. 設定區：已替換成你剛剛部署的最新網址 ---
YOUR_SHEET_ID = "14mzfOvF4osS2pfSRAUrap8EROxj0HXAo7_AHVHdtZIQ"
YOUR_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbxXYLpe7ji-Qz7lChFvB8HIF4GmG_UYyGgLliJh1XUL_SAHDP0zZedYNQMPb-DxbZ734A/exec"
...
def load_data():
    try:
        ...
        st.error(f"無法讀取 Google Sheet，請確認試算表共用權限。錯誤: {e}")
